    ...
    <div className="space-y-8">
      ...
      {achievements
        ...
        .map((game) => (
          <Card
            key={game.gameName}
            className="shadow-lg border-t-4 border-t-primary overflow-hidden transition-all duration-300 hover:shadow-xl"
          >
                ...
                <div className="flex items-center gap-2">
                  <div className="h-2 w-full sm:w-32 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(game.completedCount / game.achievements.length) * 100}%`,
                      }}
                    ></div>
                  </div>
